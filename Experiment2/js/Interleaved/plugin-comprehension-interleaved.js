var jsPsychGold1stepComprehension = (function (jspsych) {
  ...
  class Gold1ComprehensionPlugin {
    ...
    trial(display_element, trial) {
      ...
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-1-3">To <strong>choose</strong> a room for gold collecting and bomb avoiding.</label>';
      html += '</div>';
      ...
      display_element.querySelector('#jspsych-survey-multi-choice-1').addEventListener('change', function(){
        ...
        if (val === "4") {
          ...
          // Update text
          Q2.innerHTML = "That's incorrect. <br>Hint: WE collect the gold and avoid the bombs for you, but in which rooms?";
...
var jsPsychGold1stepComprehension3 = (function (jspsych) {
  ...
  class Gold1ComprehensionPlugin3 {
    ...
    trial(display_element, trial) {
      ...
      // Show preamble text
      html += '<div class="jspsych-survey-multi-choice-preamble"><img src="./img/Comprehension/Slide6.png" style="max-width: 45%"></img></div>';
      ...
      // Show preamble text
      html += '<div class="jspsych-survey-multi-choice-preamble"><img src="./img/Comprehension/Slide7.png" style="max-width: 45%"></img></div>';
      ...
      // Show preamble text
      html += '<div class="jspsych-survey-multi-choice-preamble"><img src="./img/Comprehension/Slide8.png" style="max-width: 45%"></img></div>';
